...
class SettingsComponent(Component):
    def __init__(self, master_component):
        super().__init__()
        self.view = View.SettingsView("resources/ui/settings.ui", "settingsFrame", master_component)
...
def init_components():
    ...
    settings = SettingsComponent(app.view.center_frame)
    Model.music_manager.init(app.view, songs.view)

    Model.app_page_manager.init(app.view, [songs.view, settings.view], 0)
    app.view.main_window.mainloop()
