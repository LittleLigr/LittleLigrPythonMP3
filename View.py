...
class AppView(View):
    def __init__(self, path, layout_name, master=None):
        ...
        self.recentlyTree = self.builder.get_object("recentlyTree")

        self._generate_tree_style('app.Treeview')

        self._generate_columns(self.menu)
        self._generate_columns(self.recentlyTree)

        self.menu.configure(style='app.Treeview')
        self.recentlyTree.configure(style='app.Treeview')
...
class SongsView(View):
    def __init__(self, path, layout_name, master=None):
        ...
        self.songs_tree.column('#1', anchor=CENTER, width=40)
        self.songs_tree.column('#2', anchor=CENTER, width=40)
        self.songs_tree.column('#3', anchor="center", width=40, stretch=NO)
    ...
    def _generate_tree_style(self, name):
        ...
        style.configure(name, rowheight=40)
        style.configure(name, font=('Yu Gothic UI Semilight', 14))
